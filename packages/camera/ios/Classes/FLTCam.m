...
@interface FLTCam() <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
...
- (void)captureToFile:(NSString *)path result:(FlutterResult)result API_AVAILABLE(ios(10)) {
  ...
  FLTSavePhotoDelegate *savePhotoDelegate =
      [[FLTSavePhotoDelegate alloc] initWithPath:path
                                          result:result
